  ...
  return (
    <div>
      ...
      <div className="px-4 space-y-4 pb-8">
        ...
        <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-2xl p-4">
          <div className="h-3 w-28 rounded-full bg-white/30 mb-2 shimmer" />
          <div className="h-8 w-40 rounded-full bg-white/30 mb-4 shimmer" />
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="h-3 w-28 rounded-full bg-gray-200 dark:bg-gray-700 shimmer-dark" />
          ...
          <div className="flex flex-col gap-2">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-3 flex items-center gap-3">
                ...
                <div className="h-4 w-4 rounded-full bg-gray-200 dark:bg-gray-700 shimmer-dark" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="h-3 w-20 rounded-full bg-gray-200 dark:bg-gray-700 shimmer-dark" />
            <div className="h-3 w-12 rounded-full bg-gray-200 dark:bg-gray-700 shimmer-dark" />
          </div>
