            ...
            {assets.map((asset) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{asset.name}</p>
                  {editingId === asset.id ? (
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <button onClick={() => handleUpdateAmount(asset.id)} className="text-emerald-600">
                        <Check size={14} />
                      </button>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => { setEditingId(asset.id); setEditAmount(String(asset.amount)) }}
